        ...
        <li class="nav-item dropdown user-menu">
            ...
            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                @if(isset($user) && !empty($user->avatar))
                    <img src="{{ asset(pare_url_file($user->avatar)) }}" alt="" class="user-image img-circle elevation-2">
                @else
            ...
            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <li class="user-header bg-primary">
                    @if(isset($user) && !empty($user->avatar))
                        <img src="{{ asset(pare_url_file($user->avatar)) }}" alt="" class="img-circle elevation-2">
                    @else
                ...
                <li class="user-footer">
                    <a href="{{ route('profile.index') }}" class="btn btn-default btn-flat">Thông tin tài khoản</a>
