...
<div class="row">
        ...
        <table>
            ...
            <tr>
                <th colspan="7" style="width: 100%; text-align: center; ">
                    <h3 style="font-family: 'Courier New', Courier, monospace; font-weight: bold"><b>THỐNG KÊ BỆNH NHÂN THEO BÁC SĨ KHÁM BỆNH</b></h3>
                </th>
            </tr>
            </thead>
        </table>
    ...
    <div class="col-md-12" style="text-align: center">
        <table class="table" style="border: 1px solid #000000;">
            ...
            <tr>
                <th style="width: 50px;"></th>
                <th colspan="3"><span>Bác sĩ khám bệnh: {{ $data['user'] }}</span></th>
            ...
            <tr style="border: 1px solid">
                ...
                <th style="width: 200px; border: 1px solid #000000;"><b>Dịch vụ khám</b></th>
            ...
            @if ($patients)
                @foreach ($patients as $patient)
                    <tr style="border: 1px solid #000000;">
                        ...
                        <td style="width: 150px; border: 1px solid #000000;">{{ isset($patient->specialty) ? $patient->specialty->name : ''  }}</td>
