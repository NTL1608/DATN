            ...
            <thead>
                <tr>
                    <th colspan="7" style="width: 100%; text-align: center; ">
                        <h3 style="font-family: 'Courier New', Courier, monospace; font-weight: bold"><b>THỐNG KÊ BỆNH NHÂN THEO DỊCH VỤ KHÁM BỆNH</b></h3>
                    </th>
                </tr>
            </thead>
        </table>
    ...
    <div class="col-md-12" style="text-align: center">
        <table class="table" style="border: 1px solid #000000;">
            <thead style="border: 1px solid #000000;">
                <tr>
                    <th style="width: 50px;"></th>
                    <th colspan="3"><span>Dịch vụ khám bệnh: {{ $data['specialty'] }}</span></th>
