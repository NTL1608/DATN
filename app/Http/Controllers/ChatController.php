...
class ChatController extends Controller
{
    ...
    private function getDefaultResponse($message)
    {
        ...
        return $this->ensureUtf8("Xin lỗi, tôi chưa hiểu câu hỏi của bạn. Bạn muốn đặt lịch khám, tìm bác sĩ, hay biết thêm thông tin về các chuyên khoa như $specialties? Ví dụ: 'Đặt lịch với bác sĩ A', 'Tìm bác sĩ khoa Nội', 'Lịch trống ngày mai', 'Giá khám dịch vụ Tim mạch'...");
    }
